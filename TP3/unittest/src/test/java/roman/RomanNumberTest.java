...
public class RomanNumberTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void toUpthan4() {
        RomanNumber.valueOf(4000);
    }

    @Test(expected = IllegalArgumentException.class)
    public void toRomanMultiple() {
        RomanNumber.valueOf("IIII");
    }

    @Test(expected = IllegalArgumentException.class)
    public void toRomainMultipleV() {
        RomanNumber.valueOf("VV");
    }

    @Test(expected = IllegalArgumentException.class)
    public void antFalse() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void toRomanCapsValue() {
        assertEquals(RomanNumber.valueOf(45).toString(), "XLV");
    }

    @Test(expected = IllegalArgumentException.class)
    public void fromRomanCaps() {
        RomanNumber.valueOf("Xv");
    }

    @Test(expected = IllegalArgumentException.class)
    public void otherLetters() {
        RomanNumber.valueOf("AV");
    }

    @Test(expected = IllegalArgumentException.class)
    public void withoutSpecial() {
        RomanNumber.valueOf("-V/");
    }
